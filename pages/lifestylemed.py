...
class LifeStyleMed:
    ...
    def open(self):
        self.browser.get('https://m.sport-express.ru/zozh/health/')
    ...
    def recept(self):
        recept = self.browser.find_element(By.XPATH,"//div[@class='ls-mainpage__rubrics ls-mainpage__rubrics--top']//div//a[@class='ls-rubric-menu-item ls-rubric-menu-item--sub'][contains(text(),'Медицина')]")
        recept.click()
        assert self.browser.current_url == 'https://m.sport-express.ru/tag/medicina-24637/',"No med"

    def h2(self):
        h2 = self.browser.find_element(By.XPATH,"//h1[contains(text(),'Медицина')]")
