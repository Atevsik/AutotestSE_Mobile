...
class LifeStyleDeti:
    ...
    def open(self):
        self.browser.get('https://m.sport-express.ru/zozh/hobby/')
    ...
    def recept(self):
        recept = self.browser.find_element(By.XPATH,"//div[@class='ls-mainpage__rubrics ls-mainpage__rubrics--top']//div//a[@class='ls-rubric-menu-item ls-rubric-menu-item--sub'][contains(text(),'Дети')]")
        recept.click()
        assert self.browser.current_url == 'https://m.sport-express.ru/tag/deti-9469/',"No men"

    def h2(self):
        h2 = self.browser.find_element(By.XPATH,"//h1[contains(text(),'Дети')]")
