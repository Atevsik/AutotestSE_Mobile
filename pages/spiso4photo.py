...
class Spiso4Photo:
    ...
    def k_hockey(self):
        k_hockey = self.browser.find_element(By.XPATH,"//a[contains(@class,'se-material-filter-menu__item-button')][contains(text(),'Биатлон')]")
        k_hockey.click()
        assert self.browser.current_url == 'https://m.sport-express.ru/biathlon/photoreports/', "Не правильный Биатлон"
    ...
    def mma(self):
        mma = self.browser.find_element(By.XPATH,"//div[contains(@class,'se-select__item')][contains(text(),'Чемпионат мира')]")
        mma.click()
        sleep(4)
        assert self.browser.current_url == 'https://m.sport-express.ru/biathlon/chempionat-mira/photoreports/', "Не правильный ЧМ"
