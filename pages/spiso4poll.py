...
class Spiso4Online:
    ...
    def k_hockey(self):
        k_hockey = self.browser.find_element(By.XPATH,"//a[contains(@class,'se-material-filter-menu__item-button')][contains(text(),'Теннис')]")
        k_hockey.click()
        assert self.browser.current_url == 'https://m.sport-express.ru/tennis/poll/', "Не правильный Теннис"
